...
class AlertDialogUtil {
    ...
    companion object {
        fun showEntryDeleteConfirmDialog(
            ...
            val confirmToastMessage =
                resources.getString(R.string.entry_delete_dialog_confirm_toast)
            ...
            AlertDialog.Builder(fragment.requireContext())
                ...
                .setPositiveButton(deleteText) { _, _ ->
                    fragment.requireActivity().lifecycle.coroutineScope.launch {
                        ...
                        Toast.makeText(fragment.context, confirmToastMessage, Toast.LENGTH_SHORT)
                            .show()
                    }
        ...
        fun showEntryNotSavedAlertDialog(
            fragment: Fragment
        ) {
            android.app.AlertDialog.Builder(fragment.requireContext())
                .setMessage(fragment.getString(R.string.dialog_message_exit_warning))
